...
# Comes from YAML or command line: what seqant features are called
has dbSNPnameField => (is => 'ro', isa => 'Str', required => 1);
...
has programPath => (is => 'ro', isa => 'Str', default => 'seqant-statistics');
